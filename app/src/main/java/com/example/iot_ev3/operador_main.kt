...
class operador_main : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnVolver = findViewById<ImageView>(R.id.img_operador_main_volver)
        val imgLogs = findViewById<ImageView>(R.id.img_operador_main_logs)
        val txtLogs = findViewById<TextView>(R.id.txt_operador_main_logs)
        val imgBarrera = findViewById<ImageView>(R.id.img_operador_main_barrera)
        val txtBarrera = findViewById<TextView>(R.id.txt_operador_main_barrera)
        countdownText = findViewById(R.id.txt_operador_main_countdown)
        ...
        imgBarrera.setOnClickListener {
            SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener { sDialog ->
                    sDialog.dismissWithAnimation()
                    generarEventoBarrera(idUsuario)
                }
                .show()
        }
